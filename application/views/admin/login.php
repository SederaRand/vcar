                ...
                <div class="p-5">
                  ...
                  <form method="post" action="<?php echo site_url('admin/login/verify')?>">
                    ...
                    <div class="form-group">
                     ...
                     <input type="submit" name="submit" value="Login" class="btn btn-primary btn-user btn-block" value="Login">
...
<script src="<?php echo base_url('assets/back_end/vendor/bootstrap/js/bootstrap.bundle.min.js') ?> active"></script>
